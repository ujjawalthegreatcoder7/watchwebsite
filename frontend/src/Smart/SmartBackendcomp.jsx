...
//               </a>
//               <p className='mt-4' style={{}} >{listing.description}</p>
//             </div>
//           </div>
//         ))
//       ) : (
        ...
        {currentItems.length > 0 ? (
          currentItems.map(listing => (
            <div className="block mb-2 block hover boxgap mt-3" style={{ width: '20rem', height: '30rem' }} key={listing._id}>
              <a href={`/radha/openwatchinfo/smart/${listing._id}`}>
                <img src={listing.imageforsmart} className="imagee hover card-img-top" style={{ width: '100%', height: '16rem' }} alt={listing.title} />
              </a>
              <div className="card-body">
                <a href={`/radha/openwatchinfo/smart/${listing._id}`}>
