...
import WoMan from './womencomp';
import TemporaryDrawer from '../Men/OpenDrawer';
import "./WomenimageList.css" ;
...
function srcset(image, width, height, rows = 1, cols = 1) {
  ...
  export default function WomenimageList() {
...
<div className='menshowdiv' >
  ...
  <div class="carousel-inner ">
    <div class="carousel-item active ">
      <img src={listings.imageforwomen} class="d-block  image11 " alt="..."/>
    </div>
    <div class="carousel-item">
      <img src={listings.imageforwomen} class="d-block image11" alt="..."/>
    </div>
    <div class="carousel-item">
      <img src={listings.imageforwomen} class=" image11 d-bloacks" alt="..."/>
    </div>
    <div class="carousel-item">
      <img src={listings.imageforwomen} class=" image11 d-bloacks" alt="..."/>
    </div>
...
<div className='backgroundfordescriptionwomen' >
