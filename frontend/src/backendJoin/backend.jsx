...
<div>
  <img className='home' style={{width:"100%"}}  src={home} ></img>
</div>
<div className="row row-cols-lg-5 contant">
{currentItems.length > 0 ? (
  currentItems.map(listing => (
...
<div>
  <img src={home3} className='home' style={{width:"100%"}}  ></img>
</div>
<div className="row row-cols-lg-5 contant">
{currentItems.length > 0 ? (
  currentItems.map(listing => (
...
<div>
  <img src={home4}  style={{width:"100%"}}  ></img>
</div>
<div className="row row-cols-lg-5 contant">
{currentItems.length > 0 ? (
  currentItems.map(listing => (
...
<div>
  <img src={home5} className='mb-4' style={{width:"100%"}}  ></img>
</div>
