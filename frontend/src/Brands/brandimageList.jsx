...
<div className='menshowdiv' >
  ...
  <div class="carousel-inner ">
    <div class="carousel-item active ">
      <img src={listings.imageforbrand} class="d-block  image11 " alt="..."/>
    </div>
    <div class="carousel-item">
      <img src={listings.imageforbrand} class="d-block image11" alt="..."/>
    </div>
    <div class="carousel-item">
      <img src={listings.imageforbrand} class=" image11 d-bloacks" alt="..."/>
    </div>
    <div class="carousel-item">
      <img src={listings.imageforbrand} class=" image11 d-bloacks" alt="..."/>
    </div>
...
<div className='backgroundfordescriptionbrand' >
