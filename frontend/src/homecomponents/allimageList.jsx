...
function srcset(image, width, height, rows = 1, cols = 1) {
  ...
  export default function AllimageList() {
...
<div className='menshowdiv' >
  ...
  <div class="carousel-inner ">
    <div class="carousel-item active ">
      <img src={listings.image} class="d-block  image11 " alt="..."/>
    </div>
    <div class="carousel-item">
      <img src={listings.image} class="d-block image11" alt="..."/>
    </div>
    <div class="carousel-item">
      <img src={listings.image} class=" image11 d-bloacks" alt="..."/>
    </div>
    <div class="carousel-item">
      <img src={listings.image} class=" image11 d-bloacks" alt="..."/>
    </div>
...
<div className='backgroundfordescriptionAll' >
